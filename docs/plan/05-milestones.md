...
leader election — sequencer, sweepers, janitors, relays all become registrations),
...
sequencer leader, plus the hand-built dual-sequencer exclusion test from 01 §12 —
...
sequencer, consumers, and sweepers attach the notifier to the wake seam built in
